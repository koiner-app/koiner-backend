...
export interface CurrencyProps {
  ...
  increment?: number; // TODO: add for rounding
}
...
export class Currency extends ValueObject<CurrencyProps> {
   ...
   */
  get amount(): number {
    return this.roundTo(this.props.amount);
  }
  ...
  private roundTo(amount: number, decimals = 2) {
  ...
  protected validate(props: CurrencyProps): void {
